...
function evaluateBoard(game, move, prevSum, color) {
  ...
  if (game.in_checkmate()) {
    try{parent&&parent.postMessage({type:"blank-space-achievement",blankSpaceGame:"Chess-AI",metric:"checkmates",value:1,mode:"add"},"*");}catch(e){}
...
function checkStatus(color) {
  if (game.in_checkmate()) {
    ...
    try{parent&&parent.postMessage({type:"blank-space-achievement",blankSpaceGame:"Chess-AI",metric:"checks",value:1,mode:"add"},"*");}catch(e){}

...
Install order:
1. Run supabase_v93_update.sql in your Supabase SQL Editor.
2. Upload the contents of this folder to the root of your blankspacewebsite.github.io GitHub repo.
...
- Chat pins added.
- Browser iframe loading fixed.
- Admin timed messages and command tools added; old Important/Fun Admin Tools sections removed.
